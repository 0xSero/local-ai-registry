...
## Local Inference Lab — 2026-09-13

230 source-pinned reference configurations, visible per-recipe credits and complete coverage ledger: [Local Inference Lab](LOCAL_INFERENCE_LAB.md). Snapshot SHA-256 `293d4715916d9cf4a5f978abde2dfb9df17e5656da4a37f09519dcfc567a42d1`. Upstream observations remain candidates. Our R35 TP4 engine and structured-number sweep are sourced separately to [the public Docker package](https://github.com/0xSero/glm-5.3-flash-4x-rtx-pro-6000/tree/a327a391389f8a6c218861f1fca2fcd8786e4d36).
