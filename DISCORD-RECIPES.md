...
| repo=False,hw=True,image=True | 57 | rig and image, checkpoint still only on the poster's disk |
...
Residual total: **1976** launch-shaped messages. Represented by a record: **185**.
